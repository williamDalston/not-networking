...
export async function generateMatches(userId: string, limit: number = 3) {
  try {
    // Get user profile
...
export async function updateMatchStatus(matchId: string, userId: string, status: 'accepted' | 'declined') {
  try {
...
export async function submitMatchFeedback(matchId: string, userId: string, feedback: any) {
  try {
