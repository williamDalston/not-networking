  ...
  const steps = [
    {
      ...
      content: (
        <div className="text-center">
          ...
          <p className="text-lead text-gray-600 dark:text-gray-300 mb-8 container-max-width-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Smart Matching</h3>
              <p className="text-xs text-gray-600 dark:text-gray-300">AI finds connections based on complementary skills and shared values</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="h-8 w-8 text-purple-600 dark:text-purple-400" />
              </div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Growth Circles</h3>
              <p className="text-xs text-gray-600 dark:text-gray-300">Join peer groups of 4-6 people for focused development</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Track Progress</h3>
              <p className="text-xs text-gray-600 dark:text-gray-300">Monitor your networking growth and professional development</p>
            </div>
          </div>
        </div>
      )
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <label key={skill} className="flex items-center space-x-2 p-2 border border-gray-200 dark:border-gray-600 rounded hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                    ...
                    />
                    <span className="text-xs text-gray-900 dark:text-white">{skill}</span>
                  </label>
                ))}
              </div>
            </div>
      ...
      content: (
        <div className="text-center">
          ...
          <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 max-w-md mx-auto mb-8">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">What's Next?</h3>
            <div className="space-y-3 text-left">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs text-gray-600 dark:text-gray-300">AI analyzes your profile</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-emerald-100 dark:bg-emerald-900 rounded-full flex items-center justify-center">
                  <span className="text-emerald-600 dark:text-emerald-400 text-xs font-bold">2</span>
                </div>
                <span className="text-xs text-gray-600 dark:text-gray-300">Receive personalized matches</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-emerald-100 dark:bg-emerald-900 rounded-full flex items-center justify-center">
                  <span className="text-emerald-600 dark:text-emerald-400 text-xs font-bold">3</span>
                </div>
                <span className="text-xs text-gray-600 dark:text-gray-300">Start building meaningful connections</span>
              </div>
            </div>
          </div>
        </div>
